...
# 
# test <- data_one_min %>% as_tsibble() %>% 
#   filter_index("2018-03")%>% 
#   as_tibble()
# 
# 
# t0 <- Sys.time()
...
# 
# test <- test %>% 
#   sum_over_rain_data(time_one_min)
# 
# 
# 
# test <- test %>% 
...
# 
# 
# gridExtra::grid.arrange(test %>%filter_index("2018-03-07"~"2018-03-14") %>%  autoplot(rainfall_mm),
#                         test %>%filter_index("2018-03-07"~"2018-03-14")%>% autoplot(rain_one_day_accumulated),
#                         test %>%filter_index("2018-03-07"~"2018-03-14")%>% autoplot(rain_two_day_accumulated),
#                         test %>%filter_index("2018-03-07"~"2018-03-14")%>% autoplot(rain_three_day_accumulated),
#                         test %>%filter_index("2018-03-07"~"2018-03-14")%>% autoplot(rain_four_day_accumulated),
#                         test %>%filter_index("2018-03-07"~"2018-03-14")%>% autoplot(rain_five_day_accumulated),
#                         test %>%filter_index("2018-03-07"~"2018-03-14")%>% autoplot(rain_six_day_accumulated),
#                         test %>%filter_index("2018-03-07"~"2018-03-14")%>% autoplot(rain_seven_day_accumulated)
#                         
#   
# )
# 
...
data_five_min <- temp %>% 
  filter_index("2018-01") %>%
  sum_over_rain_data(time_five_min)
...
data_fifteen_min <- temp %>% 
  filter_index("2018-01") %>%
  sum_over_rain_data(time_fifteen_min)
...
data_thirty_min <- temp %>% 
  filter_index("2018-01") %>%
  sum_over_rain_data(time_thirty_min)
